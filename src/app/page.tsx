  ...
  switch (name) {
    ...
    case "Compress Image":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M26 22l-3 3-3-3M26 28l-3-3-3 3" stroke="#fff" strokeWidth="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      );
    case "Convert PNG / JPG":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M23 21h10M23 25h7" stroke="#fff" strokeWidth="1.5" stroke-linecap="round" opacity={0.5}/>
          <path d="M17 21.5l3 0M17.5 20l2.5 1.5-2.5 1.5" stroke="#0F0F0F" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round" opacity={0.4}/>
        </svg>
      );
    case "Resize Signature":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M10 21c2-4 3.5-6 6-6s2.5 4 5 4 3.5-3 6-3" stroke="#888" strokeWidth="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          <rect x="22" y="22" width="16" height="16" rx="4" fill="#FF5C2E"/>
          <path d="M26 30l2.5 2.5 5-5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      );
    case "Signature Cleaner":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          <rect x="6" y="10" width="26" height="18" rx="4" fill="#F5F0E8" stroke="#E8E2D8" strokeWidth="0.5"/>
          <path d="M10 21c2-4 3.5-6 6-6s2.5 4 5 4 3.5-3 6-3" stroke="#888" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          <rect x="22" y="22" width="16" height="16" rx="4" fill="#FF5C2E"/>
          <path d="M26 30l2 2 2-2M26 34l2-2 2 2" stroke="#fff" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" opacity={0.9}/>
    ...
    case "Compress PDF":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M14 13h10M14 17h10M14 21h6" stroke="#aaa" stroke-width="1.5" stroke-linecap="round"/>
          <rect x="18" y="22" width="18" height="16" rx="4" fill="#FF5C2E"/>
          <path d="M27 28v5M24.5 31l2.5 2.5 2.5-2.5" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      );
    case "Merge PDF":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M17 13h10M17 17h10M17 21h6" stroke="#aaa" stroke-width="1.4" stroke-linecap="round"/>
          <rect x="20" y="22" width="16" height="16" rx="4" fill="#FF5C2E"/>
          <path d="M24 30l2.5 2.5 5-5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      );
    case "Split PDF":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          <rect x="9" y="5" width="20" height="26" rx="4" fill="#F5F0E8" stroke="#E8E2D8" strokeWidth="0.5"/>
          <path d="M14 13h10M14 17h10M14 21h6" stroke="#aaa" stroke-width="1.4" stroke-linecap="round"/>
          <line x1="9" y1="18" x2="29" y2="18" stroke="#FF5C2E" stroke-width="1.5" stroke-dasharray="3 2"/>
          <rect x="18" y="22" width="18" height="16" rx="4" fill="#FF5C2E"/>
          <path d="M22 30l5-4M22 30l5 4" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      );
    case "Image to PDF":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M11 22l3 3 3-3" stroke="#aaa" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
          <rect x="18" y="22" width="18" height="16" rx="4" fill="#FF5C2E"/>
          <path d="M22 30l2.5 2.5 5-5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      );
    case "SSC Resizer":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          <rect x="9" y="5" width="20" height="26" rx="4" fill="#F5F0E8" stroke="#E8E2D8" strokeWidth="0.5"/>
          <rect x="14" y="3" width="10" height="6" rx="2" fill="#F5F0E8" stroke="#ccc" stroke-width="1"/>
          <path d="M13 16h12M13 20h9M13 24h6" stroke="#aaa" stroke-width="1.4" stroke-linecap="round"/>
          <rect x="18" y="22" width="18" height="16" rx="4" fill="#FF5C2E"/>
          <text x="27" y="33" text-anchor="middle" fontSize="7" fontWeight="800" fill="#fff" fontFamily="'Courier New',monospace">SSC</text>
        </svg>
      );
    case "UPSC Formatter":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M13 25c0-3.3 2.7-6 6-6s6 2.7 6 6" stroke="#aaa" stroke-width="1.4" stroke-linecap="round" fill="none"/>
          <rect x="18" y="22" width="18" height="16" rx="4" fill="#FF5C2E"/>
          <text x="27" y="33" text-anchor="middle" fontSize="6" fontWeight="800" fill="#fff" fontFamily="'Courier New',monospace">UPSC</text>
        </svg>
      );
    case "IBPS Banking Forms":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M21 15h6M21 18h4M13 24h12" stroke="#aaa" stroke-width="1.4" stroke-linecap="round"/>
          <rect x="18" y="22" width="18" height="16" rx="4" fill="#FF5C2E"/>
          <text x="27" y="33" text-anchor="middle" fontSize="6.5" fontWeight="800" fill="#fff" fontFamily="'Courier New',monospace">IBPS</text>
        </svg>
      );
    case "Passport Photo Maker":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M12 27c0-3.9 3.1-7 7-7s7 3.1 7 7" stroke="#aaa" stroke-width="1.4" stroke-linecap="round" fill="none"/>
          <rect x="18" y="22" width="18" height="16" rx="4" fill="#FF5C2E"/>
          <path d="M22 30l2.5 2.5 5-5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      );
    case "PAN Card Formatter":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M20 14h8M20 17h6M20 20h7" stroke="#aaa" stroke-width="1.4" stroke-linecap="round"/>
          <rect x="22" y="22" width="16" height="16" rx="4" fill="#FF5C2E"/>
          <text x="30" y="33" text-anchor="middle" fontSize="6.5" fontWeight="800" fill="#fff" fontFamily="'Courier New',monospace">PAN</text>
        </svg>
      );
    case "Visa Photo Resizer":
      return (
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
          ...
          <path d="M21 13h9M21 17h7M21 21h8" stroke="#aaa" stroke-width="1.4" stroke-linecap="round"/>
          <rect x="22" y="22" width="16" height="16" rx="4" fill="#FF5C2E"/>
          <path d="M26 30l2.5 2.5 5-5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      );
      ...
      <main className="flex-1 bg-white">
        ...
        <section className="bg-bone border-b border-bone-dark py-16 px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h1
              className="text-4xl sm:text-5xl font-extrabold tracking-tight text-[#0F0F0F] mb-5 leading-tight"
              style={{ fontFamily: "var(--font-jakarta), system-ui, sans-serif", letterSpacing: "-0.03em" }}
            >
              Make Any File Fit{" "}
              <span className="text-gradient-brand">Any Upload Requirement</span>
            </h1>
